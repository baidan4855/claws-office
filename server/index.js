...
const SESSIONS_DIR = '/Users/jack/.openclaw/agents'
...
function getToolStatus(sessionFile) {
  ...
  try {
    ...
    // Search backwards for last tool call
...
function getCurrentTask(agentId) {
  try {
    ...
    // Fallback: get last user message
...
app.listen(port, () => console.log(`OpenClaw API running on http://localhost:${port}`))
